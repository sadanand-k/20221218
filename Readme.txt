...
add a folder with name "folder" and add hidden file in the folder with the name "hidden"
modify groupId to "Todaystask", artifactId to "yourname"and version to "20221218"
push git
clone the same repo to slave instance
modify the data in task file as mentioned below
"Hello all this is master instance"
ignore the "folder"
now pull the code into master instance and keep both data in the file.
